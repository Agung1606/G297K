...
export const TWEETS = [
  ...
  {
    userId: "8gKKRqJT1b8Qvj76LyGw",
    profile:
      "https://firebasestorage.googleapis.com/v0/b/g297k-dd26d.appspot.com/o/profiles%2FnarutoProfile.jpg?alt=media&token=3539f164-9752-4bea-aca9-7e2d6dda8c97",
    username: "uzumakinaruto_",
    date: Date(new Date().getTime() - 60 * 60 * 3000),
    tweet:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ultrices mi sed orci dignissim lobortis. Suspendisse eget efficitur sapien. Maecenas nec purus id mauris tristique lacinia. In hac habitasse platea dictumst. Quisque rhoncus semper elit, id euismod nulla suscipit ac. Nunc tincidunt diam nec commodo placerat. Sed auctor eleifend augue, ac tristique tortor tempus nec. Nam consectetur odio id tellus dignissim, eu dapibus nisi pulvinar. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Phasellus mollis purus vitae rutrum auctor. Vivamus hendrerit diam in lacinia facilisis. Sed luctus faucibus mauris, nec ultrices risus. Aliquam ultrices interdum metus a feugiat. Sed tincidunt erat nec tellus dapibus, eu fermentum tortor aliquam. Aenean hendrerit eros a ullamcorper euismod.",
  },
  {
    userId: "nzlv2xtqebadsTn1QT3C",
    profile:
      "https://firebasestorage.googleapis.com/v0/b/g297k-dd26d.appspot.com/o/profiles%2FsanjiProfile.jpg?alt=media&token=b39924fd-03fd-450c-a58b-28478c7bb96c",
    username: "vnskmj_sanji",
    date: Date(new Date().getTime() - 60 * 60 * 4000),
    tweet:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ultrices mi sed orci dignissim lobortis. Suspendisse eget efficitur sapien. Maecenas nec purus id mauris tristique lacinia. In hac habitasse platea dictumst. Quisque rhoncus semper elit, id euismod nulla suscipit ac. Nunc tincidunt diam nec commodo placerat. Sed auctor eleifend augue, ac tristique tortor tempus nec. Nam consectetur odio id tellus dignissim, eu dapibus nisi pulvinar. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Phasellus mollis purus vitae rutrum auctor. Vivamus hendrerit diam in lacinia facilisis. Sed luctus faucibus mauris, nec ultrices risus. Aliquam ultrices interdum metus a feugiat. Sed tincidunt erat nec tellus dapibus, eu fermentum tortor aliquam. Aenean hendrerit eros a ullamcorper euismod.",
  },
  {
    userId: "5TP52VOTto0UVaGxIleU",
    profile:
      "https://firebasestorage.googleapis.com/v0/b/g297k-dd26d.appspot.com/o/profiles%2FusopProfile.jpg?alt=media&token=5da389f7-feb6-4b1d-bd88-0bdbb651dc93",
    username: "usoopppp297_",
    ...
    data: [
      {
        ...
        name: "Nico Robin",
        username: "nicorobin_16",
        date: "Wed Jun 28 2023 11:28:10 GMT+0700",
        tweet:
      ...
      },
      {
        ...
        username: "vnskmj_sanji",
        date: "Wed Jun 28 2023 11:28:10 GMT+0700",
        tweet: `Love is a profound and multifaceted emotion that has captivated hearts throughout history. It has the power to ignite passion, inspire creativity, and bring immense joy and fulfillment to our lives. Love is a force that transcends boundaries, connecting individuals in the most profound and meaningful ways.

At its core, love is an unconditional acceptance and deep appreciation for another person. It is a bond that goes beyond mere attraction or infatuation. Love encompasses kindness, empathy, and a willingness to support and care for one another through both the ups and downs of life.

Love can be found in various forms: the love between romantic partners, the love between family members, and the love between friends. Each connection is unique and brings its own set of emotions and experiences. Love is an intricate tapestry of emotions, ranging from the exhilaration of new beginnings to the comfort and security of long-lasting companionship.

Love is not without its challenges. It requires effort, compromise, and understanding. It calls for vulnerability and a willingness to open our hearts to another person, knowing that we may experience both joy and pain along the way. Love requires patience and forgiveness, as we navigate the complexities of human relationships.
...
In the end, love is a celebration of the human experience. It is a reminder that, amidst the chaos of the world, there is a profound connection that binds us all together. Love is a gift that should be cherished, nurtured, and shared with others. It is a reminder that, in the presence of love, anything is possible.`,
      ...
      },
      {
        ...
        date: "Wed Jun 28 2023 11:28:10 GMT+0700",
        tweet:
          "Who needs a plan when you can punch your way through everything?",
        numberOfLikes: 0,
        numberOfComments: 0,
      },
      {
